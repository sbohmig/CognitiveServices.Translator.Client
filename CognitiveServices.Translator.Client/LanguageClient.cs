...
namespace CognitiveServices.Translator
{
	...
	public class TranslateClient : ITranslateClient, IDisposable
	{
		...
		public const int MaxNumberOfRequestContent = 25;
		public const int MaxNumberOfCharacterPerRequest = 5_000;
		...
		public TranslateClient(CognitiveServicesConfig cognitiveServiceConfig, IWebProxy proxy = null)
		{
			...
			{
				Proxy = proxy,
				UseProxy = proxy != WebRequest.DefaultWebProxy
			};
			...
			_httpClient.BaseAddress = new Uri(Constants.TranslatorApiBasePath);
		}
